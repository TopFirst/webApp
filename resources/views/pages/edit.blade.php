...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Ubah Halaman</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
				<div class="row mb-1">
					<input type="text" name="title" id="title" class="col-12 form-control @error('title') is-invalid @enderror" placeholder="Judul halaman.." autofocus value="{{ old('title', $page->title) }}">
				@error('title')
				...
				<div class="row mb-3">
					<input type="text" name="slug" id="slug" class="col-12 form-control @error('slug') is-invalid @enderror" placeholder="Slug.." readonly value="{{ old('slug', $page->slug) }}">
					@error('slug')
						<div class="invalid-feedback">
							{{ $message }}
						</div>
				...
				<div class="row">
					<div class="col-12 p-0">
						<div class="form-group">
							...
							@enderror
							<input id="body" type="hidden" name="content" value="{{ old('content', $page->content) }}">
        ...
        <div class="row justify-content-between pb-3">
            ...
            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Update Halaman</button>
        </div>
	</form>
    </div>
    <!-- /.container-fluid -->
